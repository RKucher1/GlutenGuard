...
2. Works around all hard GCal constraints
3. Learns from completion history — if they consistently skip a block type, schedule less of it
4. Keeps the structure realistic — don't pack every minute, leave buffer between blocks
